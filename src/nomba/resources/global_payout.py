...
class GlobalPayout:
    ...
    def convert_money(self, amount, currency, destination_currency, transaction_type, **extra: object) -> _models.ConvertMoneyResponse:
        """
    ...
    def fetch_global_payout_accounts(self, **extra: object) -> _models.FetchGlobalPayoutAccountsResponse:
        """
        ...
        """
        path = f"/v1/global-payout/accounts"
        params = None
        return self._client.get(path, params=params)  # type: ignore[return-value]

    def fetch_global_payout_account(self, account_id: str, **extra: object) -> _models.FetchGlobalPayoutAccountResponse:
        """

        Retrieve the details and balance of a single Global Payout account by its account ID.
        """
        path = f"/v1/global-payout/accounts/{account_id}"
        params = None
        return self._client.get(path, params=params)  # type: ignore[return-value]

    def fetch_global_payout_accounts_sandbox(self, **extra: object) -> _models.FetchGlobalPayoutAccountsSandboxResponse:
        """

        Sandbox version of Fetch Global Payout Accounts. Returns canned multi-currency account data for use in testing.
        """
        path = f"/v1/sandbox/global-payout/accounts"
        params = None
        return self._client.get(path, params=params)  # type: ignore[return-value]

    def fetch_global_payout_account_sandbox(self, account_id: str, **extra: object) -> _models.FetchGlobalPayoutAccountSandboxResponse:
        """
        ...
        """
        path = f"/v1/sandbox/global-payout/accounts/{account_id}"
        params = None
        return self._client.get(path, params=params)  # type: ignore[return-value]
...
class AsyncGlobalPayout:
    ...
    async def convert_money(self, amount, currency, destination_currency, transaction_type, **extra: object) -> _models.ConvertMoneyResponse:
        """
    ...
    async def fetch_global_payout_accounts(self, **extra: object) -> _models.FetchGlobalPayoutAccountsResponse:
        """
    ...
    async def fetch_global_payout_account(self, account_id: str, **extra: object) -> _models.FetchGlobalPayoutAccountResponse:
        """
    ...
    async def fetch_global_payout_accounts_sandbox(self, **extra: object) -> _models.FetchGlobalPayoutAccountsSandboxResponse:
        """
    ...
    async def fetch_global_payout_account_sandbox(self, account_id: str, **extra: object) -> _models.FetchGlobalPayoutAccountSandboxResponse:
        """
