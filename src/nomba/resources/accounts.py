...
class Accounts:
    ...
    def fetch_terminals_assigned_to_a_sub_account(self, account_id: str, *, limit: str | None = None, cursor: str | None = None, terminal_id: str | None = None, serial_number: str | None = None, terminal_label: str | None = None, merchant_name: str | None = None, **extra: object) -> _models.FetchTerminalsAssignedToASubAccountResponse:
        """
        Fetch terminals assigned to a sub account

        You can use this endpoint to fetch terminals linked to a sub account.
        """
        path = f"/v1/accounts/{account_id}/terminals"
        params: dict[str, object] = {}
        if limit is not None:
            params["limit"] = limit
        if cursor is not None:
...
class AsyncAccounts:
    ...
    async def fetch_terminals_assigned_to_a_sub_account(self, account_id: str, *, limit: str | None = None, cursor: str | None = None, terminal_id: str | None = None, serial_number: str | None = None, terminal_label: str | None = None, merchant_name: str | None = None, **extra: object) -> _models.FetchTerminalsAssignedToASubAccountResponse:
        """
        Fetch terminals assigned to a sub account
